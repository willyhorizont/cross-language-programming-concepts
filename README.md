...
### cross-language-features  
  ...
  13. [VB.NET](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/visual-basic-dot-net/cross-language-features.vb)  
...
### comments  
  ...
  13. [VB.NET](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/visual-basic-dot-net/comments.vb)  
...
### hello-world  
  ...
  13. [VB.NET](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/visual-basic-dot-net/hello-world.vb)  
...
### conditionals  
  ...
  13. [VB.NET](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/visual-basic-dot-net/conditionals.vb)  
...
### loops  
  ...
  13. [VB.NET](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/visual-basic-dot-net/loops.vb)  
...
### functions  
  ...
  13. [VB.NET](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/visual-basic-dot-net/functions.vb)  
...
### error-handling  
  ...
  13. [VB.NET](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/visual-basic-dot-net/error-handling.vb)  
...
### python-like list  
  ...
  13. [VB.NET](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/visual-basic-dot-net/python-like-list.vb) : List(Of Object)  
  ...
  24. [Rust](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/rust/python-like-list.java) : ArrayList&lt;Object&rs;  
  25. [Nix](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/nix/python-like-list.java) : ArrayList&lt;Object&nix;  
  26. [Tcl](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/tcl/python-like-list.java) : ArrayList&lt;Object&tcl;  
  27. [GDScript](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/gdscript/python-like-list.java) : ArrayList&lt;Object&gd;  
...
### loop-through-each-list-item  
  ...
  13. [VB.NET](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/visual-basic-dot-net/loop-through-each-list-item.vb)  
...
### get-is-any-item-in-list-matching-condition (some / any / exists / contains / includes)  
  ...
  13. [VB.NET](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/visual-basic-dot-net/get-is-any-item-in-list-matching-condition.vb)  
...
### get-is-all-item-in-list-matching-condition (every / all)  
  ...
  13. [VB.NET](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/visual-basic-dot-net/get-is-all-item-in-list-matching-condition.vb)  
...
### get-first-list-item-matching-condition (find)  
  ...
  13. [VB.NET](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/visual-basic-dot-net/get-first-list-item-matching-condition.vb)  
...
### get-index-of-list-item-matching-condition (findIndex)  
  ...
  13. [VB.NET](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/visual-basic-dot-net/get-index-of-list-item-matching-condition.vb)  
...
### get-all-list-item-matching-condition (filter / grep)  
  ...
  13. [VB.NET](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/visual-basic-dot-net/get-all-list-item-matching-condition.vb)  
...
### transform-each-list-item (map / apply)  
  ...
  13. [VB.NET](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/visual-basic-dot-net/transform-each-list-item.vb)  
...
### combine-all-list-item (reduce / fold / aggregate)  
  ...
  13. [VB.NET](https://github.com/willyhorizont/cross-language-programming-concepts/tree/main/languages/visual-basic-dot-net/combine-all-list-item.vb)  
