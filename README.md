...
10. loop-through-each-list-item:  
...
11. get-is-any-item-in-list-matching-condition (some / any / exists / contains / includes):  
...
12. get-is-all-item-in-list-matching-condition (every / all):  
...
13. get-first-list-item-matching-condition (find):  
...
14. get-index-of-list-item-matching-condition (findIndex):  
...
15. get-all-list-item-matching-condition (filter / grep):  
...
16. transform-each-list-item (map / apply):  
...
17. combine-all-list-item (reduce / fold / aggregate):  
