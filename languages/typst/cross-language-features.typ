...
print-command([multiply-by-two(10): #multiply-by-two(10)])
let multiply-by-eight = multiply(8)
print-command([multiply-by-eight(4): #multiply-by-eight(4)])
print-command([multiply-by-two(8): #multiply-by-two(8)])
...
print-command([some-python-like-list: #some-python-like-list])
...
print-command([some-python-like-dict: #some-python-like-dict])
}
